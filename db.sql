...
CREATE TABLE IF NOT EXISTS `books` (
  ...
  `remarks` varchar(512) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `books` (`id`, `order_time`, `name`, `phone`, `city`, `np_dept`, `order_1`, `order_2`, `paid`, `paid_time`, `sent`, `sent_time`, `remarks`) VALUES
